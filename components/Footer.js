...
const Footer = (props) => {
    ...
    focus && {backgroundColor: '#69696b',alignItems: 'center',}, 
    props.option === null && {display: 'none'}]}>
      <TextInput
        ...
        style={[
            ...
            focus && {width:'70%',borderRadius:20,backgroundColor:'#ECEDEF',height:'70%',paddingHorizontal:10},
        ]}
      ...
      />
        ...
        <TouchableOpacity display = {true} onPress={()=>{
          if(textDesc)
          {    
      ...
      >
          <FontAwesomeIcon icon={faCircleArrowRight} size={30} color= {focus ? '#ECEDEF' : "#3b3b3b"} />
        </TouchableOpacity>
      </View>
  )
}
